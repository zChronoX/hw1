...
function checkUsername(event) {
  ...
  if (username_value.match(pattern)) {
    fetch("check_username.php?q=" + encodeURIComponent(username_value)).then(fetchResponse).then(jsonCheckUsername);
...
function checkEmail(event) {
  ...
  if (email_value.match(pattern)) {
    fetch("check_email.php?q=" + encodeURIComponent(String(email_value).toLowerCase())).then(fetchResponse).then(jsonCheckEmail);
    form.classList.add("valid");
    form.classList.remove("invalid");
